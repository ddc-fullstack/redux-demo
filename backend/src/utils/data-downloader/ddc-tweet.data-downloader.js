...
var insertPost_1 = require("../post/insertPost");
var insertUser_1 = require("../user/insertUser");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        user = users_2[_i];
                        return [4 /*yield*/, insertUser_1.insertUser(user)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        post = posts_2[_i];
                        return [4 /*yield*/, insertPost_1.insertPost(post)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
